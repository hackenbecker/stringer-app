...
session_start();
session_destroy();
// (Removed immediate PHP redirect so the user actually sees the logout message)
...
<body data-spy="scroll" data-target="#main-nav">
  ...
  <section>
    <div class="home-section diva align-items-center">
      <div class="subheader"></div>
      <div class="firstparalogin col-lg-4 offset-lg-4">
        <div class="card button-colours text-center card-form">
          <div class="card-body">
            <h3 class="mt-4 mb-4">You have been logged out</h3>
