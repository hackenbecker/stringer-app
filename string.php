...
// Fetch Strings (Excluding "String Generic")
$query_Recordset2 = "SELECT string.*, all_string.brand, all_string.type, all_string.notes as stock_notes, sport.sportname, sport.sportid, sport.image as sport_image, reel_lengths.length 
                     FROM string 
                     ...
                     WHERE string.empty = '0' AND all_string.brand != 'String' AND all_string.type != 'Generic' 
...
$reelcosts = mysqli_fetch_assoc(mysqli_query($conn, $query_Recordset10))['totalreelprice'] ?? 0;

$query_Recordset11 = "SELECT COUNT(stringid) AS total FROM string";
$totalRows_Recordset11 = mysqli_fetch_assoc(mysqli_query($conn, $query_Recordset11))['total'] ?? 0;
...
<body data-spy="scroll" data-target="#main-nav">
          ...
          <table id="tblUser" class="table-striped table-text table table-sm center">
            ...
            <tbody>
              <?php while ($row_Recordset2 = mysqli_fetch_assoc($Recordset2)) { ?>
                <tr>
                  <td class="text-center" data-toggle="modal" data-target="#StringViewModal<?php echo e($row_Recordset2['stringid']); ?>" style="cursor:pointer;">
                    <?php echo e($row_Recordset2['stringid']); ?>
                  </td>

                  <td class="modal-text text-center" data-toggle="modal" data-target="#StringViewModal<?php echo e($row_Recordset2['stringid']); ?>" style="cursor:pointer;">
                    <?php
                    $baseType = e($row_Recordset2['brand']) . " " . e($row_Recordset2['type']);
                    echo empty($row_Recordset2['note']) ? $baseType : $baseType . " (" . e($row_Recordset2['note']) . ")";
                    ?>
                  </td>

                  <td class="text-center"><?php echo e($row_Recordset2['string_number']); ?></td>
                  <td class="text-center d-none d-md-table-cell"><?php echo e($row_Recordset2['length']) . e($units ?? ''); ?></td>
                  <td class="text-center d-none d-md-table-cell"><?php echo e($currency) . e($row_Recordset2['racket_price']); ?></td>
                  <td class="text-center"><a class="fa-solid fa-eye modal-text" href="./string-jobs-from-reel.php?stringid=<?php echo e($row_Recordset2['stringid']); ?>&sportid=<?php echo e($row_Recordset2['sportid']); ?>"></a></td>
                  <td class="text-center"><a class="fa-solid fa-pen-to-square modal-text" href="./editstring.php?stringid=<?php echo e($row_Recordset2['stringid']); ?>&sportid=<?php echo e($row_Recordset2['sportid']); ?>"></a></td>
                  <td class="text-center"><i class="fa-solid fa-trash-can modal-text" data-toggle="modal" data-target="#delModal<?php echo e($row_Recordset2['stringid']); ?>" style="cursor:pointer;"></i></td>
                  <td class="text-center"><img class="imgsporticon m-0 p-0" src="./img/<?php echo e($row_Recordset2['sport_image'] ?? ''); ?>" width="18" height="18" style="padding:0; margin:0"></td>
                </tr>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content border radius">
                      ...
                      <div class="modal-body modal_body text-dark">
                        ...
                        <span class="h6 pb-3"><?php echo e($currency) . e($row_Recordset2['reel_price']); ?></span>
                        <p class="mb-0 mt-3" style="font-size:12px">Price per racket:</p>
                        <span class="h6 pb-3"><?php echo e($currency) . e($row_Recordset2['racket_price']); ?></span>
                    ...
                    <div class="modal-content border radius">
                      ...
                      <div class="modal-body modal_body">
                        <form method="post" action="./db-update.php">
                          ...
                          <input type="hidden" name="refdelreel" value="<?php echo e($row_Recordset2['stringid']); ?>">
                      </div>
                      <div class="modal-footer modal_footer">
  ...
  <div class="container center">
    <div class="p-3 row">
      ...
      <div class="col-2"><a href="#" class="dotbt h6" title="Total string sets purchased"><?php echo $totalRows_Recordset11 ?></a></div>
      <div class="col-2"><a href="./jobs-unpaid.php" class="dotbt h6" title="Amount Owed"><?php echo $currency . e($sum_owed); ?></a></div>
      <div class="col-2"><a href="#" class="dotbtt h7" title="Total string costs"><small><?php echo $currency . e($reelcosts); ?></small></a></div>
    </div>
  </div>
