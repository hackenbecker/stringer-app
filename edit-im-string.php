...
if (isset($_POST['submitclearmessage'])) {
  ...
  $_GET['string_id'] = $_POST['stringid'];
}
//load all of the DB Queries
//-------------------------------------------------------
$query_Recordset1 = "SELECT * FROM all_string WHERE string_id = '" . $_GET['string_id'] . "' ORDER BY string_id ASC";
$Recordset1 = mysqli_query($conn, $query_Recordset1) or die(mysqli_error($conn));
$row_Recordset1 = mysqli_fetch_assoc($Recordset1);
$totalRows_Recordset1 = mysqli_num_rows($Recordset1);
//-------------------------------------------------------
$query_Recordset2 = "SELECT * FROM sport ORDER BY sportid ASC;";
$Recordset2 = mysqli_query($conn, $query_Recordset2) or die(mysqli_error($conn));
$row_Recordset2 = mysqli_fetch_assoc($Recordset2);
$totalRows_Recordset2 = mysqli_num_rows($Recordset2);
//-------------------------------------------------------
$query_Recordset3 = "SELECT * FROM all_string ORDER BY string_id ASC;";
...
<body id="home-section-results" data-spy="scroll" data-target="#main-nav">
  ...
  <div class="home-section diva">
    ...
    <p class="fxdtext"><strong>Edit</strong> In Market String</p>
    <div class="container my-1  firstparaaltej">
            ...
            <div class="card-body">
              ...
              <div>
                <div class="container">
                  <div class="row">
                    <div class="col-12">
                      <input type="text" name="brand" class="form-control txtField" value="<?php echo $row_Recordset1['brand']; ?>">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div>
                <div class="container">
                  <div class="row">
                    <div class="col-12">
                      <input type="text" name="type" class="form-control txtField" value="<?php echo $row_Recordset1['type']; ?>">
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <select class="form-control" style="width:100%" name="sportid">
                        ...
                        <?php do {
                          if ($row_Recordset2['sportid'] == $row_Recordset1['sportid']) { ?>
                            <option value="<?php echo $row_Recordset2['sportid']; ?>" selected="selected">
                              <?php echo $row_Recordset2['sportname']; ?>
                            </option>
                          <?php } else { ?>
                            <option value="<?php echo $row_Recordset2['sportid']; ?>">
                              <?php echo $row_Recordset2['sportname']; ?>
                            </option>
                          <?php } ?>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="notes" id="comments" rows="3"><?php echo $row_Recordset1['notes']; ?></textarea>
                  </div>
                </div>
              </div>
            </div>
      ...
      <input type="hidden" name="editimstring" class="txtField" value="<?php echo $_GET['string_id']; ?>">
  ...
  <div class="container center">
    <div class="p-3 row">
      ...
      <div class="col-2">
        <a href="./jobs-unpaid.php" class="dotbt h6" title="Total restrings"><?php echo $totalRows_Recordset1 ?></a>
      </div>
      <div class="col-2">
            ...
            <div class="row pt-3">
              ...
              <div class="col-4">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                  ...
                  <input type="hidden" name="stringid" class="txtField" value="<?php echo $_GET['string_id']; ?>">
                </form>
              </div>
            </div>
          </div>
