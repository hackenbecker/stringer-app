...
?>
  ...
  <head>
    <script>
      // This script executes instantly and only applies the theme from localStorage
      const storedTheme = localStorage.getItem('themeSwitch'); // Use your 'themeSwitch' key
      if (storedTheme) {
        // The CSS is written for the 'data-theme' attribute on the HTML element
