...
// SECURITY: Safely cast the racket ID to an integer to prevent SQL Injection
$racketid = 0;
if (isset($_POST['submitclearmessage'])) {
  unset($_SESSION['message']);
  $racketid = (int)$_POST['racketid'];
} elseif (isset($_GET['racketid'])) {
  $racketid = (int)$_GET['racketid'];
}

// Fetch Racket Data
$query_Recordset2 = "SELECT * FROM rackets LEFT JOIN sport ON rackets.sport = sport.sportid WHERE racketid = '$racketid'";
$Recordset2 = mysqli_query($conn, $query_Recordset2) or die(mysqli_error($conn));
$row_Recordset2 = mysqli_fetch_assoc($Recordset2);

// Fetch Sports List
$query_Recordset3 = "SELECT sportid, sportname FROM sport ORDER BY sportname ASC;";
...
<body id="home-section-results" data-spy="scroll" data-target="#main-nav">
  ...
  <div class="home-section diva">
    ...
    <p class="fxdtextb"><strong>Edit</strong> Racket</p>
          ...
          <div class="card cardvp" style="margin-top: 75px;">
            <div class="card-body">
              ...
              <div class="container">
                <div class="row">
                  <div class="col-12">
                    <input type="text" name="manuf" class="form-control txtField" value="<?php echo e($row_Recordset2['manuf']); ?>" required>
                  </div>
                </div>
              </div>
              ...
              <div class="container mb-3">
                <div class="row">
                  <div class="col-12">
                    <input type="text" name="model" class="form-control txtField" value="<?php echo e($row_Recordset2['model']); ?>" required>
                  </div>
                </div>
              </div>
            </div>
                    ...
                    <div class="col-12">
                      <select class="form-control" style="width:100%" name="sportid" required>
                        ...
                        <?php while ($row_Recordset3 = mysqli_fetch_assoc($Recordset3)) {
                          $selected = ($row_Recordset3['sportid'] == $row_Recordset2['sport']) ? "selected" : "";
                        ?>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="form-group">
                    <label for="notes">Stringing pattern</label>
                    <textarea class="form-control" name="pattern" id="notes" rows="3"><?php echo e($row_Recordset2['pattern']); ?></textarea>
                  </div>
                </div>
              </div>
              <input type="hidden" name="editracket" value="<?php echo e($racketid); ?>">
            </div>
          </div>
            ...
            <div class="row pt-3">
              ...
              <div class="col-4">
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                  ...
                  <input type="hidden" name="racketid" value="<?php echo e($racketid); ?>">
                </form>
              </div>
            </div>
          </div>
