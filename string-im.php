...
<head>
  ...
  <title>SDBA - In Market Strings</title>
        ...
        <table id="tblUser" class="table-striped table-text table table-sm center" style="top:0px; margin-top:0px; padding-top: 0px">
          ...
          <tbody>
            <?php while ($row_Recordset2 = mysqli_fetch_assoc($Recordset2)) { ?>
              <tr>
                <td class="text-center pl-3"><?php echo e($row_Recordset2['string_id']); ?></td>
                <td class="text-center pl-3"><?php echo e($row_Recordset2['brand']); ?></td>
                <td class="text-center modal-text" data-toggle="modal" data-target="#StringViewModal<?php echo e($row_Recordset2['string_id']); ?>" style="cursor:pointer;"><?php echo e($row_Recordset2['type']); ?></td>
                <td style="text-align: center"><a class="fa-solid fa-pen-to-square modal-text" href="./edit-im-string.php?string_id=<?php echo e($row_Recordset2['string_id']); ?>"></a></td>
                <td style="text-align: center"><i class="fa-solid fa-trash-can modal-text" data-toggle="modal" data-target="#delModal<?php echo e($row_Recordset2['string_id']); ?>" style="cursor:pointer;"></i></td>
                <td class="text-center"><img class="imgsporticon m-0 p-0" src="./img/<?php echo e($row_Recordset2['image'] ?? ''); ?>" width="18" height="18" style="padding:0; margin:0" title="<?php echo e($row_Recordset2['sportname']); ?>"><span class="sporttext" title="<?php echo e($row_Recordset2['sportname']); ?>"><?php echo e($row_Recordset2['sportname']); ?></span></td>
              </tr>

              <div class="modal fade" id="StringViewModal<?php echo e($row_Recordset2['string_id']); ?>">
                <div class="modal-dialog">
                  <div class="modal-content border radius">
                    <div class="modal-header modal_header">
                      <h5 class="modal-title">Brand: &nbsp;<?php echo e($row_Recordset2['brand']) ?> &nbsp;<?php echo e($row_Recordset2['type']); ?></h5>
                      <button class="close" data-dismiss="modal"><span>&times;</span></button>
                    </div>
                    <div class="modal-body modal_body text-dark">
                      <p class="form-text mb-0" style="font-size:12px">Type:</p>
                      <?php echo e($row_Recordset2['type']); ?>
                      <hr>
                      <p class="form-text mb-0" style="font-size:12px">Sport:</p>
                      <?php echo e($row_Recordset2['sportname']); ?>
                      <hr>
                      <p class="form-text mb-0" style="font-size:12px">Notes:</p>
                      <?php echo e($row_Recordset2['notes']); ?>
                    </div>
              ...
              <?php if ($_SESSION['level'] == 1) { ?>
                <div class="modal fade text-dark" id="delModal<?php echo e($row_Recordset2['string_id']); ?>">
                  <div class="modal-dialog">
                    <div class="modal-content border radius">
                      <div class="modal-header modal_header">
                        <h5 class="modal-title">You are about to delete &nbsp;"<?php echo e($row_Recordset2['string_id']); ?>"</h5>
                        <button class="close" data-dismiss="modal"><span>&times;</span></button>
                      </div>
                      <div class="modal-body modal_body">
                        <form method="post" action="./db-update.php">
                          ...
                          <input type="hidden" name="refdelstringim" class="txtField" value="<?php echo e($row_Recordset2['string_id']); ?>">
                      </div>
                      <div class="modal-footer modal_footer">
